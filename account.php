				     ...
				     <div class="register-bottom-grid">
							...
							<div>
							 ...
							 <div>
								...
								<input type="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="Password must contain:-No whites spaces,-Range 8-16 character,-Combination of UPPERCASE, lowercase, special character and numeric value." minlength="8" maxlength="16" for="password" name="password" id="password" required>
							 </div>
							 <div>
								<span>Confirm Password<label>*</label></span>
								<input type="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="Password must contain:-No whites spaces,-Range 8-16 character,-Combination of UPPERCASE, lowercase, special character and numeric value." for="password2" minlength="8" maxlength="16" name="password2" id="password2" required>
							 </div>
							 </div>
							 <div class="clearfix"> </div>
					<div class="register-bottom-grid">
